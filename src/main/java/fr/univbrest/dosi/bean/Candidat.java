...
public class Candidat implements Serializable {
	...
	public Candidat(String noCandidat, String adresse, String codePostal,
			String confirmationCandidat, Date dateNaissance,
			Date dateReponseCandidat, String email, String lieuNaissance,
			String listeSelection, String mobile, String nationalite,
			String nom, String paysOrigine, String prenom,
			BigDecimal selectionNoOrdre, String sexe, String telephone,
